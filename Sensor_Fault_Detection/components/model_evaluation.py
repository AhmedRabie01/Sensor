...
from Sensor_Fault_Detection.entity.artifact_entity import DataValidationArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
...
from Sensor_Fault_Detection.constant.training_pipeline import TARGET_COLUMN
